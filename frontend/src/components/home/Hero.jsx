      ...
      <div className="wrap hero-grid">
        <div>
          ...
          <motion.h1 variants={item}>
            Built to a written standard.
            <br />
            Since 1990.
          </motion.h1>
          <motion.p variants={item}>
            MedEvolution Inc is a US-based medical equipment manufacturer:
            fourteen product lines across four divisions, engineered from
            Cambridge, Massachusetts, produced in Shenzhen, and released only
            after unit-level QA.
          </motion.p>
