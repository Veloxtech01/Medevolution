...
function GmbeSpotlight({ children }) {
  return (
    <Reveal as="div" className="gmbe">
      <div>
        <div className="r">FEATURED PARTNER · AFRICA </div>
      ...
      <div>
        <p>
          GMBE delivers MedEvolution systems across Nigeria on a
          Design-Build-Equip-Maintain model, with offices in Lagos, Abuja, Port
          Harcourt, and Kano — providing local installation, biomedical
          engineering support, applications training, and preventive
          maintenance. Authorized distributors serve all six continents.
        </p>
        {children}
      </div>
    </Reveal>
